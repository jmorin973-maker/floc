...
export const type = {
  hero:      { fontFamily: fonts.displayBold, fontSize: 40, lineHeight: 40 * 1.1, letterSpacing: -2 },
  section:   { fontFamily: fonts.displayBold, fontSize: 32, lineHeight: 32 * 1.1, letterSpacing: -1.4 },
